...
export default function TerminosCondicionesPage() {
  return (
    <main className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="card">
        <h1 className="text-3xl font-bold text-dark-navy mb-6">Términos y Condiciones de Uso</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-neutral-gray">
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">1. Aceptación de los Términos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">2. Descripción del Servicio</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">3. Cuenta de Usuario</h2>
            
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">3.1. Creación de Cuenta</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">3.2. Responsabilidades del Usuario</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">3.3. Suspensión y Terminación</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">4. Uso Aceptable</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">5. Contenido del Usuario</h2>
            
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">5.1. Propiedad</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">5.2. Responsabilidad</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">5.3. Moderación</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">6. Suscripciones y Pagos</h2>
            
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">6.1. Planes Premium</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">6.2. Pagos</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">6.3. Renovación y Cancelación</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">6.4. Reembolsos</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">7. Propiedad Intelectual</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">8. Limitación de Responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">9. Indemnización</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">10. Modificaciones del Servicio</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">11. Modificaciones de los Términos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">12. Ley Aplicable y Jurisdicción</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">13. Disposiciones Generales</h2>
            
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">13.1. Acuerdo Completo</h3>
            <p>
              Estos Términos constituyen el acuerdo completo entre usted y Calixo respecto al uso del Servicio.
            </p>

            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">13.2. Divisibilidad</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-dark-navy mt-6 mb-3">13.3. Renuncia</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-dark-navy mt-8 mb-4">14. Contacto</h2>
            <p>
